...
Training code [link](https://codeload.github.com/ultralytics/ultralytics/zip/refs/tags/v8.3.238)
...
wget https://github.com/ultralytics/ultralytics/archive/refs/tags/v8.3.238.zip -O ultralytics-8.3.238.zip
# Unzip ultralytics
unzip ultralytics-8.3.238.zip
cd ultralytics-8.3.238
# Download models
...
# Download the image
wget -O P0015.png https://github.com/mpj1234/YOLO11-series-TensorRT10/releases/download/images/P0015.png
mv P0015.png ../images
# Run inference
